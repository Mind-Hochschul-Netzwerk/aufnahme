...
CREATE TABLE `antraege` (
  ...
  `statusaenderung_uid` int(11) NOT NULL,
...
INSERT INTO `antraege` VALUES (1358,0,1464123424,1469491200,0,0,0,1471707341,19,'A: Ja; B:ok Falls bis zum 10.08 keine Antwort--> ablehnen','','a:4:{s:13:\"MHN_Beitragen\";s:1:\"-\";s:13:\"MHN_Interesse\";s:13:\"Mensa-Website\";s:10:\"MHN_Kennen\";s:1:\"-\";s:15:\"MHN_Vorstellung\";s:1:\"-\";}');
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (19,':pbkdf2:sha256:10000:128:lZoaC5P4O/0aZbH5JlqYPQ==:HgzNu1wX57uZ7GiWOCkfva4GHy/C8xN4wPWJTvZeGMzsirPpA/pWKtv6PXQo9TZmIFsmPZSXmw7tTJIxN4I+17onga58H8jdjSoDVF35redPexlKufCFg9vxM6GKJgpjwKwMAxb/k5KgSg9oz6riQdhhfaHZJ7or30QgycAzlbY=','webteam','');
UNLOCK TABLES;
...
INSERT INTO `voten` VALUES (1358,19,2,1464159731,'An sich ein klassischer \"Spatz\", aber die geringe Mühe beim Ausfüllen drückt eine geringe Wertschätzung aus. Daher: Bitte um ausfüllen der freigelassenen Felder. ','Bitte um ausfüllen der freigelassenen Felder. '),(1358,19,2,1464209068,'Eigentlich ja, aber aus prinzip nochmal nachfragen','Engagement, Vorstellung, Erwartungen, Hobbies und Interessen'),(1358,19,2,1464264375,'dito','dito'),(1358,19,1,1464591976,'2 von 3 Kriterien erfüllt. Die fehlenden Felder kann man auch als \'kein geblubber sondern ein ehrliches weiß ich noch nicht\' sehen. Daher von mir ein knappes ja, da ankreuzbare Aufgabe auch OK sind für mich.',''),(1358,19,2,1465300588,'bisschen lieblos finde ich...','die freien Felder noch ergänzen'),(1358,19,1,1467053858,'schwaches Ja. M, Student und wenigstens grundlegende Mithilfebereitschaft.',''),(1358,19,3,1467101223,'',''),(1358,19,3,1471707080,'Hmm...','');
UNLOCK TABLES;
