...
UPDATE antraege SET statusaenderung_username = CONCAT("user ", statusaenderung_uid) WHERE statusaenderung_username IS NULL;
...
UPDATE mails SET username = CONCAT("user ", userid) WHERE username IS NULL;
...
UPDATE voten SET username = CONCAT("user ", user_id) WHERE username IS NULL;
